...
if(frozen == false){
    //�v���C���[�̍U��
    if(keyboard_check_pressed(global.controls[5])){
      playerShoot();
    }
    //�W�����v�i�������j
    if(keyboard_check_pressed(global.controls[4])){
      playerJump();
    }
    //�W�����v�i�������j
    else if(keyboard_check_released(global.controls[4])){
      playerVJump();
    }
    if keyboard_check(global.controls[5]) && global.item[1] && player.shotdelay == 0 && !dotkid playerShoot()
}

//�h�b�g�����L�[
//�f�t�H���g�ł̓I�t�ł�
//SetGlobalOption�ŃI���ɂ��Ă�������
...
if instance_exists(DotkidCircle) {sprite_index = sprDotkid; mask_index = sprDotkid; dotkid = true}
